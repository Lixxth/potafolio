...
<div className="min-w-screen min-h-screen bg-gradient-to-r from-[#07073d] to-[#550372]">
  ...
  <button className="flex w-20 h-11 mr-96 text-center border border-gray-400 rounded py-2 px-4 bg-gray-400 hover:bg-gray-700 text-white">1</button>
  <button className="flex w-20 h-11 text-center border border-gray-400 rounded py-2 px-4 bg-gray-400 hover:bg-gray-700 text-white">2</button>
  <button className="flex w-20 h-11 text-center border border-gray-400 rounded py-2 px-4 bg-gray-400 hover:bg-gray-700 text-white">3</button>
  <button className="flex w-20 h-11 text-center border border-gray-400 rounded py-2 px-4 bg-gray-400 hover:bg-gray-700 text-white">4</button>
  <button className="flex w-20 h-11 text-center border border-gray-400 rounded py-2 px-4 bg-gray-400 hover:bg-gray-700 text-white">5</button>
